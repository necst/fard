...
if(os.path.isfile("broadcast_times.txt") == False):
    with open("broadcast_times.txt", "w+") as f:
        f.write("It\tMean\tMedian\tStdev\n")

with open("broadcast_times.txt", "a") as f:

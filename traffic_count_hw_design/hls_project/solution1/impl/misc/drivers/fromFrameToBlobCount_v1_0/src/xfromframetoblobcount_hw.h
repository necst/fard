...
//        bit 1  - Channel 1 (ap_ready)
//        others - reserved
// 0x10 : Data signal of action
//        bit 31~0 - action[31:0] (Read/Write)
// 0x14 : reserved
// 0x18 : Data signal of md_threshold
//        bit 31~0 - md_threshold[31:0] (Read/Write)
// 0x1c : reserved
// 0x20 : Data signal of erosion_iteration
//        bit 31~0 - erosion_iteration[31:0] (Read/Write)
// 0x24 : reserved
// 0x28 : Data signal of dilate_iteration
//        bit 31~0 - dilate_iteration[31:0] (Read/Write)
// 0x2c : reserved
// 0x30 : Data signal of second_erosion_iteration
...
#define XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_ACTION_DATA                   0x10
#define XFROMFRAMETOBLOBCOUNT_CONTROL_BITS_ACTION_DATA                   32
#define XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_MD_THRESHOLD_DATA             0x18
#define XFROMFRAMETOBLOBCOUNT_CONTROL_BITS_MD_THRESHOLD_DATA             32
#define XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_EROSION_ITERATION_DATA        0x20
#define XFROMFRAMETOBLOBCOUNT_CONTROL_BITS_EROSION_ITERATION_DATA        32
#define XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_DILATE_ITERATION_DATA         0x28
#define XFROMFRAMETOBLOBCOUNT_CONTROL_BITS_DILATE_ITERATION_DATA         32
#define XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_SECOND_EROSION_ITERATION_DATA 0x30

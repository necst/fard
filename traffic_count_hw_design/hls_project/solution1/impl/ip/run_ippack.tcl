...
set Library     "hls"
set IPName      "fromFrameToBlobCount"
set Version     "1.0"
set DisplayName "Fromframetoblobcount"
set Revision    "1906291310"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "fromFrameToBlobCount"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {fromFrameToBlobCount_urem_10ns_9ns_10_14_1
fromFrameToBlobCount_mac_muladd_9ns_8ns_8ns_15_3_1
fromFrameToBlobCount_mul_mul_10ns_12ns_22_3_1
erode_filter_lineBuf_val_1
fromFrameToBlobCount_mac_muladd_8ns_5ns_15ns_15_3_1
fromFrameToBlobCount_mul_mul_17ns_19ns_36_3_1
fromFrameToBlobCount_mac_muladd_8ns_5ns_15ns_15_1_1
fromFrameToBlobCount_mul_mul_17ns_19ns_36_1_1
fromFrameToBlobCount_background
fromFrameToBlobCount_input_grey
fromFrameToBlobCount_foreground_clean
fromFrameToBlobCount_control_s_axi
erode_filter
copy
dilate
cleanBorders
...
## Variables
set Top "fromFrameToBlobCount"
set TopNoPrefix "fromFrameToBlobCount"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 action W 0x0 "Data signal of action" {{0 32 action W 0 "Bit 31 to 0 Data signal of action"}}} {0x18 md_threshold W 0x0 "Data signal of md_threshold" {{0 32 md_threshold W 0 "Bit 31 to 0 Data signal of md_threshold"}}} {0x20 erosion_iteration W 0x0 "Data signal of erosion_iteration" {{0 32 erosion_iteration W 0 "Bit 31 to 0 Data signal of erosion_iteration"}}} {0x28 dilate_iteration W 0x0 "Data signal of dilate_iteration" {{0 32 dilate_iteration W 0 "Bit 31 to 0 Data signal of dilate_iteration"}}} {0x30 second_erosion_iteration W 0x0 "Data signal of second_erosion_iteration" {{0 32 second_erosion_iteration W 0 "Bit 31 to 0 Data signal of second_erosion_iteration"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control streamIn streamOut"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"

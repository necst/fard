...
if {[file isfile fromFrameToBlobCount.autotvin.dat]} {
	file delete -force fromFrameToBlobCount.autotvin.dat
}

if {[file isfile fromFrameToBlobCount.autotvout.dat]} {
	file delete -force fromFrameToBlobCount.autotvout.dat
}

# ==============================================================
# File generated on Wed Apr 17 14:27:04 CEST 2019
# Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
# SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
# IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/mas/Xilinx/Vivado/2018.3/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mas/Xilinx/Vivado/2018.3/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mas/Xilinx/Vivado/2018.3/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mas/Xilinx/Vivado/2018.3/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mas/Xilinx/Vivado/2018.3/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fromFrameToBlobCount.autotvin.dat"
	set constFileTvOut       "fromFrameToBlobCount.autotvout.dat"
	set constFileHdlTvIn     "fromFrameToBlobCount.autohdltvin.dat"
	set constFileHdlTvOut    "fromFrameToBlobCount.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

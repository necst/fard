...
void XFromframetoblobcount_Set_width(XFromframetoblobcount *InstancePtr, u32 Data) {
    ...
    XFromframetoblobcount_WriteReg(InstancePtr->Control_BaseAddress, XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_WIDTH_DATA, Data);
}
...
u32 XFromframetoblobcount_Get_width(XFromframetoblobcount *InstancePtr) {
    ...
    Data = XFromframetoblobcount_ReadReg(InstancePtr->Control_BaseAddress, XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_WIDTH_DATA);
    return Data;
}
...
void XFromframetoblobcount_Set_height(XFromframetoblobcount *InstancePtr, u32 Data) {
    ...
    XFromframetoblobcount_WriteReg(InstancePtr->Control_BaseAddress, XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_HEIGHT_DATA, Data);
}
...
u32 XFromframetoblobcount_Get_height(XFromframetoblobcount *InstancePtr) {
    ...
    Data = XFromframetoblobcount_ReadReg(InstancePtr->Control_BaseAddress, XFROMFRAMETOBLOBCOUNT_CONTROL_ADDR_HEIGHT_DATA);
    return Data;
}
